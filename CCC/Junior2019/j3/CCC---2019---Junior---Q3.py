def CCC_2019_Junior_Question_3(input_string):
    ...
    for line in lines[1:]:    
        ...
        while index < len(line):
            if index == len(line) - 1 or line[index] != line[index+1]: 
                new_str = new_str + str(character_count) + " " + line[index] + " "
                character_count = 1
            else:
...
def run_all_test_cases(test_dict):
    for testcase in test_dict:
        ...
        print("----------Input:  ")
        print(input_string)
        received_output = CCC_2019_Junior_Question_3(input_string) #CHANGE NAME OF THIS FUNCTION
...
print(user_input_string)
print("result:")
print(CCC_2019_Junior_Question_3(user_input_string)) 
