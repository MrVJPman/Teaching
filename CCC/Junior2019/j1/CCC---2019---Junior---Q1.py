def CCC_2019_Junior_Question_1(input_string):
    ...
    sum_of_apple = 3 * int(lines[0]) + 2 * int(lines[1]) + int(lines[2])
    sum_of_banana = 3 * int(lines[3]) + 2 * int(lines[4]) + int(lines[5])

    if sum_of_apple > sum_of_banana :     #Case 1 : apple > banna
        solution_string = "A" 
    elif sum_of_apple == sum_of_banana:     #Case : apple == bannana
        solution_string = "T"    
    else:     #case 3: apple < banana
        solution_string = "B"
...
def run_all_test_cases(test_dict):
    for testcase in test_dict:
        ...
        print("----------Input:  ")
        print(input_string)
        received_output = CCC_2019_Junior_Question_1(input_string) #CHANGE NAME OF THIS FUNCTION
...
print(user_input_string)
print("result:")
print(CCC_2019_Junior_Question_1(user_input_string)) 
