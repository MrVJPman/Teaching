def CCC_2017_Junior_Question_2(input_string):
    ...
    number_to_be_shifted = int(lines[0])
    number_of_shifts = int(lines[1])    
    shifty_sum = 0
    for index in range(0, number_of_shifts + 1):
        shifty_sum = shifty_sum + number_to_be_shifted * (10 ** index)
    solution_string = str(shifty_sum)
...
def run_all_test_cases(test_dict):
    for testcase in test_dict:
        ...
        print("----------Input:  ")
        print(input_string)
        received_output = CCC_2017_Junior_Question_2(input_string) #CHANGE NAME OF THIS FUNCTION
...
print(user_input_string)
print("result:")
print(CCC_2017_Junior_Question_2(user_input_string)) 
