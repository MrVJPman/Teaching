def CCC_2016_Junior_Question_1(input_string):
    ...
    game_results = []
    for s in lines:
        game_results.append(s)
    if game_results.count("W") >= 5:
        solution_string = "1"
    elif game_results.count("W") >= 3:
        solution_string = "2"
    elif game_results.count("W") >= 1:
        solution_string = "3"
    else:
        solution_string = "-1"
...
def run_all_test_cases(test_dict):
    for testcase in test_dict:
        ...
        print("----------Input:  ")
        print(input_string)
        received_output = CCC_2016_Junior_Question_1(input_string) #CHANGE NAME OF THIS FUNCTION
...
print(user_input_string)
print("result:")
print(CCC_2016_Junior_Question_1(user_input_string)) 
